        ...
        NavigationStack {
            List {
                ...
                topic("waveform", "Obraz, nebo jen zvuk",
                      "Přepínač nahoře volí, co hlavní obrazovka ukazuje. Obraz ukazuje živé video z postýlky. Jen zvuk ukazuje jen pokojíček: kruh, který se rozvlní se zvukem, a slovy, co se děje. Obraz se nezobrazuje. Z kamery se přesto stahuje v nižším rozlišení, protože některé kamery (třeba Tapo) bez obrazu neposílají ani zvuk. Z telefonu u miminka jde jen zvuk.",
